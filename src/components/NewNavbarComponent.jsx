...
const NewNavbarComponent = () => {
  ...
  return (
    <nav className="bg-background min-h-[50px] sm:relative absolute w-full z-10">
      <div className="container mx-auto sm:flex pt-3 sm:pt-0 gap-4 min-h-[50px] justify-center items-center">
        ...
        <div className={`sm:flex sm:space-x-1 ${isOpen ? "hidden" : "block"}`}>
          <NavLink className="block text-center p-3">Home</NavLink>
          <span className="sm:flex hidden p-3">|</span>
          <NavLink className="block text-center p-3">Shop</NavLink>
        </div>
        <div
        ...
        >
          <NavLink className="block text-center p-3">Admin Dashboard</NavLink>
          <span className="sm:flex hidden p-3">|</span>
          <NavLink className="block text-center p-3">Welcome, Name</NavLink>
          <span className="sm:flex hidden p-3">|</span>
          <NavLink
            to="/cart"
